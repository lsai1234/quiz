...
function buildMetafields(cfg) {
  const fields = [
    ...
    { namespace: 'chrgd', key: 'servings',              type: 'number_integer',         value: String(cfg.servings ?? 30) },
    ...
    { namespace: 'chrgd', key: 'servings_per_unit',     type: 'number_integer',         value: String(cfg.servingsPerUnit ?? cfg.servings ?? 30) },
