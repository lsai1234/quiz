...
import { servingsAppliesTo } from '@/lib/catalogue/servings'
            ...
            <Row
              ...
              help={
                servingsAppliesTo(product) > 1
                  ? `How many servings one unit holds at the normal dose. It is what the shop shows for the ${servingsAppliesTo(product)} SKUs of this size — a SKU of a different size keeps its own.`
