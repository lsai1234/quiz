...
export function HubSkeleton() {
  const card = { background: GLASS.surface, border: `1px solid ${GLASS.hairline}` }

  return (
    <div aria-hidden>
      {/* Greeting */}
      <Skeleton width={96} height={10} radius={6} />
      <Skeleton width={168} height={26} radius={8} className="mt-2.5" />

      {/* Next box hero */}
      <div className="rounded-3xl p-5 mt-5" style={card}>
        <Skeleton width={140} height={10} radius={6} />
        <Skeleton width="72%" height={24} radius={8} className="mt-2.5" />
        <Skeleton width="54%" height={12} radius={6} className="mt-2.5" />
        <div className="flex gap-2 mt-4">
          <Skeleton height={44} radius={16} className="flex-1" />
          <Skeleton width={92} height={44} radius={16} />
        </div>
      </div>
      ...
      <div className="rounded-2xl p-5 mt-5" style={card}>
        <div className="flex items-center justify-between">
          <Skeleton width={104} height={10} radius={6} />
          <Skeleton width={72} height={18} radius={6} />
        </div>
        <Skeleton height={10} radius={6} className="mt-3" />
        <Skeleton width="82%" height={10} radius={6} className="mt-2" />
      </div>
      ...
      <div className="flex gap-3 mt-6 overflow-hidden">
        {[0, 1, 2].map((i) => (
          <div key={i} className="w-36 shrink-0 rounded-2xl p-3.5" style={card}>
            ...
            <Skeleton width={58} height={30} radius={8} className="mt-2.5" />
            <Skeleton height={10} radius={6} className="mt-3" />
          </div>
        ))}
      </div>
      ...
      {/* Stack */}
      <Skeleton width={80} height={10} radius={6} className="mt-7" />
          ...
          <div key={i} className="rounded-2xl p-4" style={card}>
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <Skeleton width="42%" height={10} radius={6} className="mt-2" />
                <Skeleton width="54%" height={10} radius={6} className="mt-2" />
              </div>
            </div>
            <div className="flex gap-2 mt-4">
              <Skeleton height={40} radius={12} className="flex-1" />
