...
export function buildSubscriptionCheckout(
  ...
  const { usageByProductId, level, introDiscountOverride, partnerDiscountPct } = options
  const planOpts = { usageByProductId, level, introDiscountOverride, partnerDiscountPct }
