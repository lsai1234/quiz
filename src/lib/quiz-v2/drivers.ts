...
export const DRIVERS: Record<DriverId, DriverMeta> = {
  ...
  'sleep-debt':         { label: 'Short nights',        heard: 'you’re running on less sleep than you need' },
  ...
  'stress-load':        { label: 'Pressure',            heard: 'you’re carrying a lot at the moment' },
  'wired-evening':      { label: 'Wired evenings',      heard: 'you’re still wired when you should be winding down' },
  'screen-fatigue':     { label: 'Screen hours',        heard: 'you spend most of the day looking at a screen' },
  'sedentary-slump':    { label: 'Sitting still',       heard: 'you’re sitting for most of the day' },
  'training-load':      { label: 'Training load',       heard: 'you’re training hard and often' },
  'recovery-debt':      { label: 'Recovery',            heard: 'you’re not bouncing back between sessions' },
  'joint-load':         { label: 'Joints',              heard: 'the aches and niggles hang around' },
  'plateau':            { label: 'Plateau',             heard: 'progress has flattened out' },
  'micronutrient-gap':  { label: 'Everyday gaps',       heard: 'there are some everyday gaps in what you eat' },
  ...
  'illness-frequency':  { label: 'Run down often',      heard: 'you pick things up more often than you’d like' },
