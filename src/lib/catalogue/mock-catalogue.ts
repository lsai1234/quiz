...
const RAW_MOCK_CATALOGUE: CatalogueProduct[] = [
...

  {
    ...
    imageUrl: null,
    brand: 'CHRGD', // replace with real URL when available
    category: 'Protein',
    stackSlots: ['protein'],
  ...
  // ─── MIXABLE DRINKS ──────────────────────────────────────────────────────────
  // Drinkable (powder/effervescent) counterparts to the capsule staples, for
  // anyone who would rather drink a staple than swallow it. Priorities tie with
  // the capsule equivalents: array order keeps the existing picks unchanged.

  {
    id: 'chrgd-daily-fizz',
    title: 'CHRGD Daily Fizz',
    handle: 'chrgd-daily-fizz',
    ...
    variants: [
      { id: 'chrgd-daily-fizz-berry-300g', title: 'Sparkling Berry / 300g', flavour: 'Sparkling Berry', size: '300g', price: 18.99, compareAtPrice: 24.99, available: true },
      { id: 'chrgd-daily-fizz-citrus-300g', title: 'Citrus Spritz / 300g', flavour: 'Citrus Spritz', size: '300g', price: 18.99, compareAtPrice: 24.99, available: true },
    ],
    basePrice: 18.99,
    compareAtPrice: 24.99,
    subscriptionEligible: true,
...

  {
    ...
    servings: 30,
    swapGroup: 'sleep-support',
    // Strictly below magnesium (5) and the sleep blend (4), so the sleep
    // steering keeps its existing picks.
