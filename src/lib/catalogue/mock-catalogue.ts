...
export const MOCK_CATALOGUE: CatalogueProduct[] = [
...

  {
    ...
    subscriptionEligible: true,
    subscriptionProductId: 'chrgd-creatine-monthly',
    isSubscriptionOnly: false,
    daysOfSupply: 90,
    swapGroup: 'creatine',
...

  {
    ...
    subscriptionEligible: true,
    subscriptionProductId: 'chrgd-omega-3-monthly',
    isSubscriptionOnly: false,
    daysOfSupply: 90,
    swapGroup: 'omega-3',
    recommendationPriority: 6,
...

  {
    ...
    subscriptionEligible: true,
    subscriptionProductId: 'chrgd-vitamin-d-monthly',
    isSubscriptionOnly: false,
    daysOfSupply: 60,
    swapGroup: 'vitamin-d',
    recommendationPriority: 5,
...

  {
    ...
    subscriptionEligible: true,
    subscriptionProductId: 'chrgd-vitamin-c-monthly',
    isSubscriptionOnly: false,
    daysOfSupply: 90,
    swapGroup: 'vitamin-c',
    recommendationPriority: 4,
  ...
  // Hidden from the quiz (isSubscriptionOnly). These are the monthly-sized
  // equivalents that longer-lasting products flip to on subscription, so the
  // monthly plan is always available. Mapped via `subscriptionProductId`.

  {
    id: 'chrgd-creatine-monthly',
    title: 'CHRGD Creatine — Monthly Refill',
    handle: 'chrgd-creatine-monthly',
    description: 'Monthly-sized micronised creatine, 5g per serving — a 30-day refill sized for monthly delivery.',
    imageUrl: null,
    category: 'Performance',
    stackSlots: ['performance'],
    goals: ['muscle', 'performance', 'bulking'],
    ...
    formats: ['powder'],
    variants: [
      { id: 'chrgd-creatine-monthly-150g', title: 'Unflavoured / 150g', flavour: 'Unflavoured', size: '150g', price: 8.99, compareAtPrice: 10.99, available: true, shopifyVariantId: null },
    ],
    basePrice: 8.99,
    ...
    isBoosterEligible: false,
    hasStimulants: false,
    shortReason: 'Monthly-sized creatine refill — same 5g daily dose, sized for monthly delivery.',
    warnings: [],
    shopifyProductId: null,
  },

  {
    id: 'chrgd-omega-3-monthly',
    title: 'CHRGD Omega-3 — Monthly Refill',
    handle: 'chrgd-omega-3-monthly',
    description: 'High-strength fish oil, 1000mg EPA & DHA — a 30-day refill sized for monthly delivery.',
    imageUrl: null,
    category: 'Health',
    stackSlots: ['health'],
    goals: ['health', 'recovery', 'focus'],
    ...
    formats: ['capsules'],
    variants: [
      { id: 'chrgd-omega-3-monthly-30', title: '30 Softgels', flavour: null, size: '30 softgels', price: 6.99, compareAtPrice: 8.99, available: true, shopifyVariantId: null },
    ],
    basePrice: 6.99,
    compareAtPrice: 8.99,
    subscriptionEligible: true,
    ...
    isBoosterEligible: false,
    hasStimulants: false,
    shortReason: 'Monthly-sized omega-3 refill — same daily EPA & DHA, sized for monthly delivery.',
    warnings: ['Contains fish. Not suitable for vegans, vegetarians or those with fish allergies.'],
    shopifyProductId: null,
  },

  {
    id: 'chrgd-vitamin-d-monthly',
    title: 'CHRGD Vitamin D3 + K2 — Monthly Refill',
    handle: 'chrgd-vitamin-d-monthly',
    description: 'Vitamin D3 3000IU with K2 MK-7 — a 30-day refill sized for monthly delivery.',
    imageUrl: null,
    category: 'Health',
    stackSlots: ['health'],
    goals: ['health', 'immune'],
    ...
    formats: ['capsules'],
    variants: [
      { id: 'chrgd-vitamin-d-monthly-30', title: '30 Capsules', flavour: null, size: '30 caps', price: 7.99, compareAtPrice: 9.99, available: true, shopifyVariantId: null },
    ],
    basePrice: 7.99,
    compareAtPrice: 9.99,
    subscriptionEligible: true,
    ...
    isBoosterEligible: false,
    hasStimulants: false,
    shortReason: 'Monthly-sized vitamin D3 + K2 refill, sized for monthly delivery.',
    warnings: [],
    shopifyProductId: null,
  },

  {
    id: 'chrgd-vitamin-c-monthly',
    title: 'CHRGD Vitamin C + Zinc — Monthly Refill',
    handle: 'chrgd-vitamin-c-monthly',
    description: '1000mg Vitamin C with 15mg Zinc — a 30-day refill sized for monthly delivery.',
    imageUrl: null,
    category: 'Health',
    stackSlots: ['health'],
    goals: ['immune', 'health'],
    ...
    formats: ['capsules'],
    variants: [
      { id: 'chrgd-vitamin-c-monthly-30', title: '30 Tablets', flavour: null, size: '30 tabs', price: 4.99, compareAtPrice: 5.99, available: true, shopifyVariantId: null },
    ],
    basePrice: 4.99,
    compareAtPrice: 5.99,
    subscriptionEligible: true,
    ...
    isBoosterEligible: false,
    hasStimulants: false,
    shortReason: 'Monthly-sized vitamin C + zinc refill, sized for monthly delivery.',
    warnings: [],
    shopifyProductId: null,
  },
]
