...
export const MOCK_CATALOGUE: CatalogueProduct[] = [
  ...
  // ─── LQD DRINKS ──────────────────────────────────────────────────────────────
  // Drinkable counterparts to the capsule staples, so a CHRGD LQD package can
  // cover vitamins, sleep and immunity entirely in drinks. Priorities tie with
  // the capsule equivalents: array order keeps normal-mode picks unchanged,
  // while LQD mode (and powder-preferring quizzers) get these.

  {
    id: 'chrgd-lqd-daily',
    title: 'CHRGD LQD Daily',
